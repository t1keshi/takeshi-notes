...
O conceito chave para alcançar estes objetivos é a **classe**. Em C++, a classe possui diversos mecanismos que permitem a aplicação de diversas técnicas de programação de forma combinada:
