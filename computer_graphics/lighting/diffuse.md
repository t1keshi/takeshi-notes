...
> **Nota:** Se a matriz **model-view** não contém escala não uniforme podemos utilizar diretamente a parte 3x3 da matriz **model-view**.

> **Nota:** Se a matriz **model-view** contiver escala uniforme, é necessário normalizar o resultado da transformação.
